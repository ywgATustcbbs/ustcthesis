...
\begin{description}
\item[数学类]{xeCJK、amsmath、amsthm、amsfonts、amssymb、bm}
\item[格式类]{titletoc、titlesec、geometry}
\item[表格类]{multicol、multirow}
\item[其他]{hyperref、natbib}
\end{description}
...
\item[条件载入]{eulervm（仅在文档类选项中同时注明了extra和euler时载入）}
\end{description}
...
\subsection{模板下载与使用}
本模板及本示例文件可以在Google Project网站\url{http://code.google.com/p/ustcthesis}下载。
